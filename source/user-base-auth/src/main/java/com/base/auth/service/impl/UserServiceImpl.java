...
public class UserServiceImpl implements UserDetailsService {
    ...
    public OAuth2AccessToken getAccessTokenForEmail(ClientDetails client, TokenRequest tokenRequest, String email, String password, AuthorizationServerTokenServices tokenServices) throws GeneralSecurityException, IOException {
        Map<String, String> requestParameters = new HashMap<>();
        requestParameters.put("grantType", SecurityConstant.GRANT_TYPE_EMAIL);
