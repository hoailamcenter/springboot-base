...
public class CustomTokenEnhancer implements TokenEnhancer {
    ...
    public OAuth2AccessToken enhance(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
        ...
        if(grantType != null){
            switch (grantType) {
                case SecurityConstant.GRANT_TYPE_USER:
                    ...
                    break;
                case SecurityConstant.GRANT_TYPE_EMAIL:
                    String email = authentication.getOAuth2Request().getRequestParameters().get("email");
                    additionalInfo = getAdditionalInfo(email, grantType);
                    break;
                case SecurityConstant.GRANT_TYPE_PASSWORD:
                    String emailAddress = authentication.getOAuth2Request().getRequestParameters().get("email");
                    String username = authentication.getOAuth2Request().getRequestParameters().get("username");
                    if (username == null){
                        additionalInfo = getAdditionalInfo(emailAddress, grantType);
                    } else {
                        additionalInfo = getAdditionalInfoByUsername(username, grantType);
                    }
                    break;
            }
        }
    ...
    private Map<String, Object> getAdditionalInfo(String email, String grantType) {
        Map<String, Object> additionalInfo = new HashMap<>();
    ...
    private Map<String, Object> getAdditionalInfoByUsername(String username, String grantType) {
        Map<String, Object> additionalInfo = new HashMap<>();
