...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public TokenStore tokenStore() {
        JdbcTokenStore j = new JdbcTokenStore(jdbcSecondaryTemplate.getDataSource());
    ...
    public void configure(ClientDetailsServiceConfigurer configure) throws Exception {
        configure.jdbc(jdbcSecondaryTemplate.getDataSource());
    }
    ...
    private TokenGranter tokenGranter(final AuthorizationServerEndpointsConfigurer endpoints) {
        ...
        granters.add(new CustomPasswordTokenGranter(authenticationManager, endpoints.getTokenServices(), endpoints.getClientDetailsService(), endpoints.getOAuth2RequestFactory(),userService));
        ...
        granters.add(new CustomTokenGranter(authenticationManager, endpoints.getTokenServices(), endpoints.getClientDetailsService(), endpoints.getOAuth2RequestFactory(), SecurityConstant.GRANT_TYPE_EMAIL, userService));
